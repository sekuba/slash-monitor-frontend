...
if you run it locally with a sequencer admin api in the env you get the bonus info of 'offense types', knowing why someone is being slashed. this feature is not included in the github pages version
