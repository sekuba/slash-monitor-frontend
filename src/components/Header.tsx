        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="bg-brand-black border-5 border-chartreuse p-3 shadow-brutal-chartreuse hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all duration-100"
              aria-label="View on GitHub"
            >
              <svg
                className="w-8 h-8 text-chartreuse"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
