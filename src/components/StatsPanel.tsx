...
export function StatsPanel() {
  ...
  const statCards = [
    ...
    {
      label: 'Active Slashings',
      value: stats.activeSlashings,
      color: stats.activeSlashings > 0 ? 'text-red-500' : 'text-gray-400',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    {
      label: 'Total Slashed',
      value: `${formatEther(stats.totalSlashAmount)} ETH`,
      color: 'text-red-500',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
